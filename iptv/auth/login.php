...
// Buscar usuário pelo email, INCLUINDO is_admin
...
$_SESSION['user_id'] = $usuario['id'];
$_SESSION['user_name'] = $usuario['nome'];
$_SESSION['is_admin'] = (bool) $usuario['is_admin']; // SALVA O STATUS ADMIN NA SESSÃO
...
jsonResponse([
    ...
    'user' => [
        ...
        'nome' => $usuario['nome'],
        'email' => $email,
        'is_admin' => $_SESSION['is_admin'] // Retorna também para o frontend
    ]
]);