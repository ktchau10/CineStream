...
async function initializeMovieDetails() {
    ...
    try {
        ...
        currentImdbId = movieDetails.imdb_id;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (watchNowBtn && playerModal && playerContainer && closeModalBtn) {
        ...
        // 2. Abrir o modal ao clicar em "Assistir Agora"
        watchNowBtn.addEventListener('click', () => {
            if (currentImdbId) {
                // Constrói a URL da Superflix para FILMES
                // Adiciona personalizações (#color, #noEpList)
                const playerUrl = `https://superflixapi.asia/filme/${currentImdbId}#color:e50914#noEpList`;
    ...
    // --- ⬆️ FIM DO BLOCO PARA ADICIONAR ⬆️ ---
